...
export default function PulseDashboard() {
  ...
  const todayRange = useMemo(() => {
    ...
    return {
      ...
      todayDateISO: start.toISOString().split('T')[0],
    };
  }, []);
  ...
  // ============================================================
  // ✅ OPTIMIZED DASHBOARD LOAD - SINGLE RPC CALL
  // ============================================================
  // This replaces 20+ database queries with 1 optimized query
  ...
  function calculateDateRange(filter: 'DAY' | 'WEEK' | 'MONTH' | 'YEAR' | 'RANGE') {
    const now = new Date();
    let startDate: Date;
  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-2 pt-3 mt-2 border-t border-gray-200 dark:border-gray-700">
              <div className="text-xs">
                ...
                <div className="font-semibold text-red-600">{metrics?.overdueCount ?? 0}</div>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      {/* Advanced Analytics Section - keeping all the charts from original code */}
      <div className="space-y-6">
        <Card className="jewel-card">
          <CardContent className="pt-6">
