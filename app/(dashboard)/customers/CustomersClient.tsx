...
export default function CustomersClient({ 
  ...
  const inactiveCount = customers.filter(c => (c.status || 'ACTIVE').toUpperCase() === 'INACTIVE').length;
          ...
          <AlertDescription>
            ...
            {rlsError && (
              <div className="mt-4 p-4 bg-muted rounded-lg">
                <p className="text-sm font-semibold mb-2">Developer: Run this SQL in Supabase:</p>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-orange-600">{inactiveCount}</div>
          </CardContent>
        </Card>
      </div>
                ...
                {filteredCustomers.length === 0 ? (
                  ...
                  filteredCustomers.map((customer) => (
                    <TableRow key={customer.id} className="hover:bg-muted/50">
                      ...
                      <TableCell>
                        <Badge 
                          variant={(customer.status || 'ACTIVE').toUpperCase() === 'ACTIVE' ? 'default' : 'secondary'}
                          className={(customer.status || 'ACTIVE').toUpperCase() === 'ACTIVE' ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : ''}
                        >
